...
static void run_mpy2 (int BS, int n_threads, const Matrix &a, const Matrix &b,
					   const Matrix &c, Matrix &d) {
    vector<double> times;
    for (int i=0; i<5; ++i) {
	auto start = start_time();
	d.mpy2 (a, b, BS, n_threads);
...
int main () {
    ...
    run_mpy2 (BS,  1, a, b, c, d);	//Parameters are BS, # threads, matrices
